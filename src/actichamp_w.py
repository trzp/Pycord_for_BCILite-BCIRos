...
CHAMP_6_VERSION_CTRL =  0x640D0716    # 100.13.07.22 FX2 USB controller
...
CHAMP_6_VERSION_DSP =   0x670E0303    # 103.14.03.03 MSP430
...
class ActiChamp(object):
    ...
    def readImpedances(self):
        ...
        if err2 == CHAMP_ERR_MONITORING:
            raise AmpError("failed to read data from device", err2)
        ...
        return np.fromstring(self.impbuffer, np.uint32, items)
    ...
    def getBatteryVoltage(self):
        ...
        if self.running:
            for idx, target in [("V3", 3.3), ("DVDD3", 3.3), ("AVDD3", 3.3), ("AVDD5", 5.0), ("REF", 2.048)]:
